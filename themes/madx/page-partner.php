...
// Get term parent id
$la_parent    = get_term_by('slug','latin-america',$region_tax);
...
// Get term parent id
$asia_parent    = get_term_by('slug','asia',$region_tax);
...
// Get term parent id
$africa_parent    = get_term_by('slug','africa',$region_tax);
...
// Get term parent id
$europe_parent    = get_term_by('slug','europe',$region_tax);
...
// Get term parent id
$australia_parent    = get_term_by('slug','australia',$region_tax);
...
// Get term parent id
$mideast_parent    = get_term_by('slug','middle-east',$region_tax);
