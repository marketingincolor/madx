	...
	<nav class="site-navigation top-bar" role="navigation">
		<div class="top-bar-left">
			<div class="site-desktop-title top-bar-title no-print">
				<a href="/automotive" rel="home"><img src="<?php bloginfo( 'template_directory' ); ?>/dist/assets/images/l-automotive.svg" alt="Madico The Clear Choice" class="menu-section-home-image"></a>
			</div>
		</div>
