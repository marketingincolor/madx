	...
	<nav class="site-navigation top-bar" role="navigation">
		<div class="top-bar-left">
			<div class="site-desktop-title top-bar-title">
				<a href="/specialty-solutions" rel="home"><img src="<?php bloginfo( 'template_directory' ); ?>/dist/assets/images/madico-page-logo.png" alt="Madico The Clear Choice"></a>
			</div>
		</div>
		<div class="top-bar-right tablet">
	      ...
	      <li>
	        ...
	        <?php foundationpress_specialty_nav(); ?>
	      </li>
	    </ul>
		</div>
	</nav>
