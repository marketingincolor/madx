	...
	<div class="site-title-bar title-bar" <?php foundationpress_title_bar_responsive_toggle(); ?>>
		<div class="title-bar-left no-print">
			...
			<span class="site-mobile-title title-bar-title">
				<a href="/automotive" rel="home"><?php bloginfo( 'template_directory' ); ?></a>
			</span>
		</div>
	</div>
	...
	<nav class="site-navigation top-bar" role="navigation">
		<div class="top-bar-left">
			<div class="site-desktop-title top-bar-title no-print">
				<a href="/automotive" class="no-print" rel="home"><img src="<?php bloginfo( 'template_directory' ); ?>/dist/assets/images/l-automotive.svg" alt="Madico The Clear Choice" class="no-print"></a>
			</div>
		</div>
