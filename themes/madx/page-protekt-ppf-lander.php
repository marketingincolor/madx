<?php 
/**
 * Template Name: Protekt PPF Landing Page
 *
...
<html lang="en">
    <head> 
        ...
        <meta charset="utf-8">
        <meta property="og:title" content="Protekt® PPF by Madico® | Madico, Inc." />
        <meta property="og:description" content="Protekt® PPF (Paint Protection Film) is a transparent, automotive paint protection film that delivers a one-of-a-kind, industry-leading top coat—and through-the-roof sales for your business." />
        ...
        <link rel="stylesheet" id="main-stylesheet-css" href="http://madicomain.staging.wpengine.com/wp-content/themes/madx/dist/assets/css/app.css?ver=2.10.4" type="text/css" media="all">
...
<script type='text/javascript' src='http://www.madico.com/wp-content/plugins/gravityforms/js/conditional_logic.min.js?ver=1.9.16'></script> -->
        ...
        <style>
            ...
            .hero{
            	background-image:url(<?php echo get_template_directory_uri(); ?>/dist/assets/images/protekt-hero.jpg);
            ...
            .features{
            	background-image: url(<?php echo get_template_directory_uri(); ?>/dist/assets/images/protekt-img-car.jpg);
            	background-position: center center;
            	background-repeat: no-repeat;
            	background-size: cover;
            	padding: 8% 0;
            ...
            .features .features-list p, .car .features-list p, .road .features-list p { padding-left:24px; position:relative; top:-5px; margin:0; }
            .car{
            	background-image: url(<?php echo get_template_directory_uri(); ?>/dist/assets/images/protekt-img-bike.jpg);
            	background-position: center center;
            	background-repeat: no-repeat;
            	background-size: cover;
            	padding: 8% 0;
            ...
            .road{
                background-image: url(<?php echo get_template_directory_uri(); ?>/dist/assets/images/protekt-img-road.jpg);
                background-position: center center;
                background-repeat: no-repeat;
                background-size: cover;
                padding: 8% 0;
            ...
            .road h3{ margin-right:3em; color:#fff; }
            h3 { font-size:30px; font-weight:600; letter-spacing:-1.1px; margin-bottom:1rem;}

            .testimonials{
                background-image: url(<?php echo get_template_directory_uri(); ?>/dist/assets/images/protekt-img-car-alt.jpg);
                background-position: center center;
                background-repeat: no-repeat;
                background-size: cover;
                padding: 8% 0;
            ...
            .testimonials .quote-mark { margin-top:20px; }
            ...
            .protekt-form img{ margin-bottom: 30px; }
            .protekt-form h3{ color:#FFF; font-size: 30px; padding:0 30px; }
            .protekt-form p{ color:#FFF; margin-bottom:10px; font-size:0.875em; }
            .protekt-form .fdesc { padding:1em 2em; }
            .protekt-form #field_28_8 label{ margin-bottom:10px; }
            .protekt-form .questions { margin-top:1.75em !important; }
            .form-section { margin:30px !important; }
            .form-submit-button { margin-top:0px !important; }
            .footer{padding:5% 0; }
            .footer img{ margin-bottom:30px; }
            .footer p{ color:rgb(26, 26, 26); font-size:13px; }
            .footer a{ font-size: 13px; color:rgb(26, 26, 26); }
            ...
            @media(max-width: 640px){
                ...
                .hero { padding:70px 0px 100px 0px; background-image:linear-gradient( rgba(255, 255, 255, 0.90), rgba(255, 255, 255, 0.10) ),url(<?php echo get_template_directory_uri(); ?>/dist/assets/images/protekt-hero.jpg); }
    ...
    <body>
          ...
          <div class="row">
              <div class="small-12 columns">
                  <div class="top-bar-left">
                      <p>With Protekt PPF, your sales will shine on!</p>
                  </div>
                  <div class="top-bar-right">
                      <a href="#protekt-form" id="dealer-button" class="button">Tell Me More!</a>
                  </div>
              </div>
          </div>
        </div>
        ...
        <section class="features">
            <div class="row">
                <img src="<?php echo get_template_directory_uri(); ?>/dist/assets/images/protekt-img-car-mobile.jpg" alt="A Smart Investment" class="show-for-small-only">
                <div class="small-12 medium-5 medium-offset-6 large-4 large-offset-7 columns end">
                    <div class="mobile-features">
                        <h3>More than Just Beautiful.<br>A Smart Investment.</h3>
                        <p>Applying paint protection film does more than protect a vehicle's paint finish. It protects an owner's investment, saving on costly repairs and repainting. Virtually self-healing, Protekt PPF advanced top coat eliminates fine lines over time&mdash;while working hard to protect vehicles from exterior body-blemishing threats, including: </p>
                        <ul class="features-list">
                        	<li><i class="fa fa-check" aria-hidden="true"></i><p>Scratches</p></li>
                        	<li><i class="fa fa-check" aria-hidden="true"></i><p>Chemicals</p></li>
                            <li><i class="fa fa-check" aria-hidden="true"></i><p>Stones</p></li>
                            <li><i class="fa fa-check" aria-hidden="true"></i><p>Bugs</p></li>
                            <li><i class="fa fa-check" aria-hidden="true"></i><p>Sand</p></li>
                            <li><i class="fa fa-check" aria-hidden="true"></i><p>Salt</p></li>
                            <li><i class="fa fa-check" aria-hidden="true"></i><p>Discoloration</p></li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <section class="car">
            <div class="row">
                <img src="<?php echo get_template_directory_uri(); ?>/dist/assets/images/protekt-img-bike-mobile.jpg" alt="Protekt PPF Motorcycle" class="show-for-small-only">
                <div class="small-12 medium-5 medium-offset-1 columns end">
                    <div class="mobile-car">
                        <h3>It's Not Just for Cars.</h3>
                        <p>Protekt PPF advanced, optically-clear film is ideal for all forms of transportation, providing superior protection for:</p>
                        <ul class="features-list">
                            <li><i class="fa fa-check" aria-hidden="true"></i><p>Trucks</p></li>
                            <li><i class="fa fa-check" aria-hidden="true"></i><p>RVs</p></li>
                            <li><i class="fa fa-check" aria-hidden="true"></i><p>ATVs</p></li>
                            <li><i class="fa fa-check" aria-hidden="true"></i><p>Jet skis</p></li>
                            <li><i class="fa fa-check" aria-hidden="true"></i><p>Boats</p></li>
                            <li><i class="fa fa-check" aria-hidden="true"></i><p>Motorcycles</p></li>
                            <li><i class="fa fa-check" aria-hidden="true"></i><p>Tractors</p></li>
                            <li><i class="fa fa-check" aria-hidden="true"></i><p>Commercial vehicles</p></li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <section class="road">
            <div class="row">
                <div class="small-12 medium-10 medium-offset-1 columns">
                    <div class="mobile-road row">
                        <div class="small-12 medium-4 columns">
                            <h3>We Cover a Full Range of Vehicle Surfaces.</h3>
                        </div>
                        <div class="small-12 medium-8 columns end">
                            <div class="row">
                                <div class="small-12 medium-4 columns">
                                    <ul class="features-list">
                                        <li><i class="fa fa-check" aria-hidden="true"></i><p>Hood</p></li>
                                        <li><i class="fa fa-check" aria-hidden="true"></i><p>Side view mirrors</p></li>
                                        <li><i class="fa fa-check" aria-hidden="true"></i><p>Rear quarter panel</p></li>
                                        <li><i class="fa fa-check" aria-hidden="true"></i><p>Wiper blade landing areas</p></li>
                                        <li><i class="fa fa-check" aria-hidden="true"></i><p>Under utility racks</p></li>
                                    </ul>
                                </div>
                                <div class="small-12 medium-4 columns">
                                    <ul class="features-list">
                                        <li><i class="fa fa-check" aria-hidden="true"></i><p>Bumpers</p></li>
                                        <li><i class="fa fa-check" aria-hidden="true"></i><p>Grills</p></li>
                                        <li><i class="fa fa-check" aria-hidden="true"></i><p>Truck bed rails</p></li>
                                        <li><i class="fa fa-check" aria-hidden="true"></i><p>Door handles and locks</p></li>
                                        <li><i class="fa fa-check" aria-hidden="true"></i><p>Around wheel wells</p></li>
                                    </ul>
                                </div>
                                <div class="small-12 medium-4 columns">
                                    <ul class="features-list">
                                        <li><i class="fa fa-check" aria-hidden="true"></i><p>Fenders</p></li>
                                        <li><i class="fa fa-check" aria-hidden="true"></i><p>Rocker panels</p></li>
                                        <li><i class="fa fa-check" aria-hidden="true"></i><p>Door frame edges and thresholds</p></li>
                                        <li><i class="fa fa-check" aria-hidden="true"></i><p>Roof areas</p></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
        ...
        <section class="testimonials">
        	<div class="row">
        		<img src="<?php echo get_template_directory_uri(); ?>/dist/assets/images/protekt-img-car-alt-mobile.jpg" alt="Protekt PPF testimonials" class="show-for-small-only">
                <div class="medium-5 medium-offset-7 columns end">
                    <img src="<?php echo get_template_directory_uri(); ?>/dist/assets/images/protekt-quote-icon.png" alt="Testimonial Quote" class="quote-mark">
                </div>
                <div class="medium-5 medium-offset-7 columns end">
                      ...
                      <div class="orbit-wrapper">
                        <ul class="orbit-container">
                          <li class="is-active orbit-slide">
                            <p>Protekt PPF has been an incredible addition to our product offerings and our installers find it easy to work with. Our customers are pleased with the outcome and love how the film protects their vehicles’ paint finishes especially on areas such as the fender and bumper"</p>
                            <address class="gray-p">
                                  <span class="author">&mdash;Narayan Andrews</span><br>
                                  <span class="job">Spectrum Auto in Colorado Springs, Colorado</span>
                                </address>
                          </li>
                        </ul>
                      </div>
        ...
        <div class="protekt-form" id="protekt-form">
        	<div class="row">
        	  <div class="medium-offset-2 medium-8 large-6 large-offset-3 columns text-center">
        	    <img src="<?php echo get_template_directory_uri(); ?>/dist/assets/images/protekt-form-icon.png" alt="">
        	    <h3>With Protekt PPF, your sales will shine on!</h3>
        ...
        <section class="footer">
        	<div class="row">
                <div class="small-12 columns text-center">
                    <img src="<?php echo get_template_directory_uri(); ?>/dist/assets/images/protekt-logo-header.png" alt="Protekt PPF Logo" width="330">
