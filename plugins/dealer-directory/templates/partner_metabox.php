...
<style>
    ul.partner_meta {}
    ul.partner_meta li {}
    ul.partner_meta li label { display:inline-block; text-align:right; min-width:20%; }
    ul.partner_meta li input[type=text] { min-width:40%; }
</style>

<ul class="partner_meta">
    <li>
        <label for="meta_dname">Partner Name</label>
        <input type="text" id="meta_dname" name="partner_name" value="<?php echo @get_post_meta($post->ID, 'partner_name', true); ?>" />
    </li>
    <li>
    ...
    <li>
        <label for="_enable_dealer">Partner Enabled</label>
